...
微積分是計算數學的一個分支，主要研究連續函數的求積、導數與極限的概念。在機器學習中，微積分的概念有助於我們理解和掌握[梯度下降（gradient descent）算法](/post/gradient-descent-introduction)，以及訓練神經網路的過程——因為模型訓練的本質，就是透過求導找到讓損失函數最小的參數更新方向。
...
- [梯度下降法介紹：一階最佳化算法如何找到局部極小值？](/post/gradient-descent-introduction)：微積分在機器學習最直接的應用，可接著看導數如何用來更新模型參數。
