...
範例中把 \`reconnection\` 設為 \`false\`，代表重連改由應用程式自己處理。Python client 也有類似做法，可以參考 [Python Socket.IO Client 4.5.1 不會自動重連：503 後的排查與手動重連寫法](/post/python-socketio-client-451-reconnect-issue)。
